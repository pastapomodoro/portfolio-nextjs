    ...
    <div className={cn("relative h-full w-full", className)} {...props}>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }} className="size-full">
        <motion.div
          ...
          variants={{ initial: { backgroundPosition: startPositions }, animate: { backgroundPosition: [startPositions, endPositions], transition: { duration, ease: "linear", repeat: Number.POSITIVE_INFINITY } } }}
          initial="initial"
          animate="animate"
        />
      </motion.div>
