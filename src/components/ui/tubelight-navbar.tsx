...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    <div className={cn("fixed bottom-0 sm:top-0 sm:bottom-auto left-1/2 -translate-x-1/2 z-50 mb-6 sm:pt-6 pointer-events-none", className)}>
      <div className="flex items-center gap-3 bg-background/70 border border-border backdrop-blur-lg py-1 px-1 rounded-full shadow-sm pointer-events-auto">
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "relative cursor-pointer text-sm font-light px-6 py-2 rounded-full transition-colors",
